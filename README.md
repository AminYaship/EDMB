...
> **Scope / disclaimer.** This is a local demo/evaluation setup for
> reproducibility and testing, not a production deployment. The containerized
> stack is the upstream Dataverse "Demo or Evaluation" stack; do not expose it
...
| `validation/validate_madmp.py` | Serialize a populated block → maDMP v1.1 and validate |
